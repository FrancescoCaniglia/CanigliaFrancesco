...
public class DefaultCyclingraceFrontendService implements CyclingraceFrontendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCyclingraceFrontendService.class);
	...
	{
		return DefaultCyclingraceFrontendService.class.getResourceAsStream("/cyclingraceFrontend/sap-hybris-platform.png");
	}
