 ...
 */
package my.cyclingraceFrontend.jalo;
...
/**
 * This is the extension manager of the CyclingraceFrontend extension.
 */
public class CyclingraceFrontendManager extends GeneratedCyclingraceFrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclingraceFrontendManager.class);
	 ...
	 */
	public static CyclingraceFrontendManager getInstance()
	{
		return (CyclingraceFrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclingraceFrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclingraceFrontendManager() // NOPMD 
	{
		LOG.debug("constructor of CyclingraceFrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclingraceFrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclingraceFrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
