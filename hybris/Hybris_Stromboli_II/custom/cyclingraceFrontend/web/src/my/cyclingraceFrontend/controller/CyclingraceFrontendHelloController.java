 ...
 */
package my.cyclingraceFrontend.controller;
...
@Controller
public class CyclingraceFrontendHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", cyclingraceFrontendService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
