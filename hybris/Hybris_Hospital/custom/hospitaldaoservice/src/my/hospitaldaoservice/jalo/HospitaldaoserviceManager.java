 ...
 */
package my.hospitaldaoservice.jalo;
...
/**
 * This is the extension manager of the Hospitaldaoservice extension.
 */
public class HospitaldaoserviceManager extends GeneratedHospitaldaoserviceManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitaldaoserviceManager.class);
	 ...
	 */
	public static HospitaldaoserviceManager getInstance()
	{
		return (HospitaldaoserviceManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitaldaoserviceConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitaldaoserviceManager() // NOPMD 
	{
		LOG.debug("constructor of HospitaldaoserviceManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitaldaoserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitaldaoserviceManager called, current tenant: {}", getTenant().getTenantID());
	}
