...
public class DefaultHospitaldaoserviceService implements HospitaldaoserviceService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitaldaoserviceService.class);
	...
	{
		return DefaultHospitaldaoserviceService.class.getResourceAsStream("/hospitaldaoservice/sap-hybris-platform.png");
	}
