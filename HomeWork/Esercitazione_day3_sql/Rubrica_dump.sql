...
INSERT INTO Contatto (id, name, cognome, numero, smartphone, indirizzo, citta, provincia, email) VALUES
					(null, 'francesco', 'vietri', '3408326352', 11,'','','',''),
					(null, 'antonia', 'coviello', '3472305493', 2,'via tribunali', 'napoli', 'na', ''),
					(null, 'simona', 'palumbo', '3318096926', 4, 'via pinco pallo', 'caserta', 'na', ''),
					(null, 'francesco', 'randillo', '3468315563', 7, 'via ariano', 'ariano irpino', 'av', 'francescorandillo@live.it'),
					(null, 'francesca', 'di mare', '3286314283', 12,'via posillipo', 'napoli', 'na', 'francesca.dimare@hotmail.it'),
					(null, 'francesco', 'caniglia', '3428446811', 19,'piazza a. gentileschi', 'brindisi', 'br', 'caniglia.francesco011@gmail.com'),
					(null, 'francesco', 'riccardo', '3526458966', 1,'piazza dei funghi porcini', 'monteforte irpino', 'av',''),
					(null, 'angelo', 'giordano', '3201456985', 6,'via della bicicletta', 'nocera superiore', 'sa',''),
					(null, 'mario', 'saponara', '3214562145', 12,'','rocca d\'aspide','',''),
					(null, 'silverio gregorio', 'vaira', '3402569874', 7,'','castelnuovo della d\'aunia','fg', '' ),
					(null, 'rosanna', 'desolda', '3474559198', 3, 'piazza a. gentileschi', 'brindisi', 'br', ''),
					(null, 'laura', 'caniglia', '3415621456', 2, 'piazza delle cento foglie', 'mesagne', 'br', '');
